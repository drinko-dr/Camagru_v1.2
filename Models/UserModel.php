...
class UserModel extends Model
{
    ...
    public function send_confirmation_mail($email, $pseudo, $key)
    {
        ...
        $content = 'Welcome to Camagru.
       	Чтобы подтвердить свою учетную запись, нажмите на ссылку ниже или скопируйте ее в свой браузер.
        https://camagru-dr.loc//index.php/activation?log=' . urlencode($pseudo) . '&key=' . urlencode($key) . '
        ---------------
